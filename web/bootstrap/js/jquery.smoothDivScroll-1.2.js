...
(function ($) {
	...
	$.widget("thomaskahn.smoothDivScroll", {
		...
		options: {
			...
			visibleHotSpotBackgrounds: "always", // always, onstart or empty (no visible hotspots)
			hotSpotsVisibleTime: 1000, // Milliseconds
			easingAfterHotSpotScrolling: true, // Boolean
			easingAfterHotSpotScrollingDistance: 15, // Pixels
			easingAfterHotSpotScrollingDuration: 100, // Milliseconds
			easingAfterHotSpotScrollingFunction: "easeInQuint", // String
			...
			autoScrollingInterval: 50, // Milliseconds
